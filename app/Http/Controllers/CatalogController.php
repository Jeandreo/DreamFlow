...
class CatalogController extends Controller
{
    ...
    public function __construct(Request $request, Catalog $content)
    {
    ...
    public function index()
    {
        ...
        return view('pages.catalogs.index')->with([
            'contents' => $contents,
        ]);
    ...
    public function show($id)
    {
        ...
        // RETURN VIEW WITH DATA
        return view('pages.catalogs.show')->with([
            'contents' => $contents,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.catalogs.edit')->with([
            'content' => $content,
        ]);
    }
