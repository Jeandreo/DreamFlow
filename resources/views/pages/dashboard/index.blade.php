...
<div class="row">
    ...
    <div class="col-12 col-md-5">
        ...
        <div class="card mb-4">
            <div class="card-body p-2">
                <textarea class="form-control form-control-solid" name="notes" rows="13" placeholder="Anotações aqui...">{{ Auth::user()->notes }}</textarea>
            </div>
        </div>
    </div>
    <div class="col-12 col-md-4 d-grid align-items-stretch mb-4">
        @include('pages.dashboard.meals.index')
    </div>
    ...
    <div class="col-12 col-md-4 d-grid align-items-stretch">
        <div class="card mb-4">
            <div id="carousel_list" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100 overflow-hidden" data-bs-ride="carousel" data-bs-interval="5000">
